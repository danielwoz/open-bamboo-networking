...
//
// Lifted from BambuStudio-bridge/src/bambu_bridge/server/ICameraSource.hpp on
// 2026-06-14 (Wave 4 STREAM_CAMERA). Namespace re-rooted under
// `bambu_net::camera` and stripped of the bridge-only `Slic3r::bridge::server`
// hierarchy; the public surface (VideoFrame, ICameraSource, StreamInfo)
// is preserved byte-for-byte so the lifted *CameraSource impls below
// compile unchanged.
//
